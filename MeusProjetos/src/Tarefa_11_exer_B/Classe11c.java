 ...
 * @author FO
 */
public class Classe11c extends Object {
    ...
    public void IdadeMenor() {
        ...
        if (idade < 18) {
            ...
            if (salario < MenorSalario_MenorIdade) {
                MenorSalario_MenorIdade = salario;
            }

            if (salario > MaiorSalario_MenorIdade) {
                MaiorSalario_MenorIdade = salario;
            }
        }
    }        
    ...
    public void IdadeMaior(){
        ...
        if (idade >= 18) {
            ...
            if (salario < MenorSalario_MaiorIdade ) {

                MenorSalario_MaiorIdade = salario;

            }
            if (salario > MaiorSalario_MaiorIdade) {
