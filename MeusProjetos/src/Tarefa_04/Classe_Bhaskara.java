...
public class Classe_Bhaskara 
{
    ...
    {      System.out.print("============== RESULTADO ==============");       
           ...
           if (a == 0 || b == 0 || c ==0)
            {    
                System.out.println( "OBS: >>> O coeficiente \"A, B ou C\" devem ser diferentes de \"ZERO\" para Equação do 2º Grau. <<<\n"
                                    + "Programa finalizado!!!\n");        
            }
            else if( delta >= 0)
    ...
    {   Scanner leitor = new Scanner(System.in);
        Classe_Bhaskara BSK = new Classe_Bhaskara();
