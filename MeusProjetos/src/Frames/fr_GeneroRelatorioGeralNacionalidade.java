...
public class fr_GeneroRelatorioGeralNacionalidade extends javax.swing.JFrame {

    DAO_Nacionalidade dao = new DAO_Nacionalidade ();

    ArrayList<Nacionalidade>  lista = new ArrayList ();
    
    public fr_GeneroRelatorioGeralNacionalidade() {
        initComponents();
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new fr_GeneroRelatorioGeralNacionalidade().setVisible(true);
            }
        });
    }
...
private void geraRelatorio() throws Exception {
    ...
    String st = "Relatório de Nacionalidade de Pessoas\n\n";
    
    lista = dao.Consulta_Nacionalidade();
    
    for ( int i = 0; i< lista.size(); i++) {
        
        st = st + "\n     Código: " + lista.get(i).getCd_Nacionalidade();
        st = st + "\n  Descrição: " + lista.get(i).getDs_Nacionalidade();
        st = st + "\nAbreviatura: " + lista.get(i).getAbr_Nacionalidade();
        st = st + "\n\n";
